...
<p>IPMon has four main modes:
  ...
  <li>configure sendmail<br>in /etc/mail/sendmail.mc<br>  
  - change 'dnl MASQUERADE_AS('yourdomain.com')dnl to the domain of your mail server<br>
  - delete 'localhost' in 'DAEMON_OPTIONS('Port=smtp, Name=MTA')dnl<br></li>
